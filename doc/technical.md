...
- 游戏：Frosted Window
- 类型：casual
- 简述：Drag to wipe the steam — fast swipe = thin line, slow drag = wide brush, hold to fatten. Six scenes: vanity mirror, neon city, cabin, aquarium, sunset palms, blossom. Live drips + ambient pads.
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Frosted Window；cover_url=/poster.png；category=casual；uuid=1f9d3ce7-4ded-4ab1-8556-58310a8e5b29
